...
cut -d' ' -f1-4 ${selectionIII} | sort | uniq | wc -l  | tee -a ${LOGFILE}
echo -e "\n" | tee -a ${LOGFILE}

echo "The number of unique HIGH impact variants is: "  | tee -a ${LOGFILE}
grep "HIGH" ${selectionIII} | cut -d' ' -f1-4 | sort | uniq | wc -l  | tee -a ${LOGFILE}
echo -e "\n" | tee -a ${LOGFILE}

echo "The number of unique MODERATE impact variants is: "  | tee -a ${LOGFILE}
grep "MODERATE" ${selectionIII} | cut -d' ' -f1-4 | sort | uniq | wc -l  | tee -a ${LOGFILE}
echo -e "\n" | tee -a ${LOGFILE}

echo "The number of unique LOW impact variants is: "  | tee -a ${LOGFILE}
grep "LOW" ${selectionIII} | cut -d' ' -f1-4 | sort | uniq | wc -l  | tee -a ${LOGFILE}
echo -e "\n" | tee -a ${LOGFILE}

echo "The number of unique MODIFIER impact variants is: "  | tee -a ${LOGFILE}
grep "MODIFIER" ${selectionIII} | cut -d' ' -f1-4 | sort | uniq | wc -l  | tee -a ${LOGFILE}
echo -e "\n" | tee -a ${LOGFILE}
